document.addEventListener("DOMContentLoaded", function () {
  ...
  function fetchWeather(city) {
    const apiKey = "c150a831aa1a7257aab64e99dea14985";
  ...
  function displayLibraries(data) {
    ...
    resultsDiv.innerHTML +=
      "<h3>Top 5 Bibliotheken:</h3>" + placesHTML.join("");
  }
  ...
  function displayReligiousPlaces(data) {
    ...
    resultsDiv.innerHTML +=
      "<h3>Top 5 Religieuze Plaatsen:</h3>" + placesHTML.join("");
  }


//   function fetchSupermarkets(latitude, longitude) {
//     // Maak de Overpass API-aanroep met de verkregen coördinaten
//     const overpassUrl = `https://overpass-api.de/api/interpreter?data=[out:json];
...
//       .catch((error) => {
//         alert(
//           "Er is een probleem opgetreden bij het ophalen van supermarktgegevens."
//         );
//       });
// }

// function displaySupermarkets(data) {
//   // Sorteer en neem de top vijf supermarkten, indien sorteer criterium beschikbaar
//   const topFiveSupermarkets = data.elements.slice(0, 5); // Neemt de eerste 5

//   const supermarketsHTML = topFiveSupermarkets.map((element) => {
//       let name = element.tags.name || "Onbekend";
//       let openingHours = element.tags.opening_hours || "Niet beschikbaar";
...
//   // Toon de top vijf supermarkten in de resultatenDiv
//   resultsDiv.innerHTML = "<h3>Top 5 Supermarkten:</h3>" + supermarketsHTML.join("");
// }
